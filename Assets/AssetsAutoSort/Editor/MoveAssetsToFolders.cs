...
public class MoveAssetsToFolders : MonoBehaviour, IPanelTool
{
    public string ToolName { get; set; }
    private static string FileName = "";
    private static string selectedFolder = "";

    public MoveAssetsToFolders()
    {
        ToolName = typeof(MoveAssetsToFolders).Name;
    }

    public void Execute()
    {
        MoveAssetsToFolders.exec();
    }
    ...
    [MenuItem("AssetTools/Move Assets To Folders %#d")]
    [MenuItem("Assets/AssetTools/Move Assets To Folders %#d")]
